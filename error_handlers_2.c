...
/**
 * _div_error - Prints division error messages for division by 0.
...
/**
 * _pint_error - Prints pint error messages for empty stacks.
 * @line_number: Line number in Monty bytecodes file where error occurred.
 *
 * Return: (EXIT_FAILURE) always.
 */
...
/**
 * _pchar_error - Prints pchar error messages for empty stacks
